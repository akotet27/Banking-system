// Stroke-based SVG icons. All accept className prop.

export function BankIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2L2 8h20L12 2z" />
      <path d="M3 8v2h18V8" />
      <path d="M3 18h18" /><path d="M3 20h18" />
...
export function EnvelopeIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function StoreIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 9h18l-2-5H5L3 9z" /><path d="M3 9v11h18V9" />
      <path d="M9 9v11" /><path d="M15 9v5a2 2 0 01-2 2h-2a2 2 0 01-2-2V9" />
    </svg>
  );
}

export function InboxArrowDownIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 12l3-7h14l3 7" /><path d="M2 12v7a1 1 0 001 1h18a1 1 0 001-1v-7" />
      <path d="M12 6v8" /><path d="M9 11l3 3 3-3" />
    </svg>
  );
}

export function BankNoteIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function ExclamationIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function QrCodeIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14 14h.01M14 17h3M17 14h3M17 20h3M20 17h.01" />
    </svg>
  );
}
...
export function FingerprintIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 10a2 2 0 10-4 0v2a6 6 0 0012 0v-2a2 2 0 10-4 0" />
...
export function PhoneIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.5a19.79 19.79 0 01-3-8.57A2 2 0 012.18 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 9.91a16 16 0 006.18 6.18l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
    </svg>
  );
}

export function RwandaFlagIcon({ className = "w-5 h-3.5" }) {
  return (
    <svg className={className} viewBox="0 0 30 20" xmlns="http://www.w3.org/2000/svg">
      <rect width="30" height="20" rx="1.5" fill="#20603D"/>
      <rect width="30" height="11" fill="#00A1DE"/>
      <rect y="11" width="30" height="1.5" fill="#FAD201"/>
      <rect y="12.5" width="30" height="7.5" fill="#20603D"/>
      <circle cx="22" cy="5.5" r="2.2" fill="#FAD201"/>
      <circle cx="22" cy="5.5" r="1.4" fill="#FAD201" stroke="#00A1DE" strokeWidth="0.3"/>
    </svg>
  );
}
