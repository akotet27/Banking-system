...
import {
  ...
  ClockIcon, ShieldCheckIcon, EnvelopeIcon,
...
export default function ProfilePage() {
  ...
  const verificationSteps = [
    ...
    },
    {
      ...
      sub: "Requires the Ishimwe Bank mobile app",
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-slate-900 dark:text-white">Fingerprint on this device</p>
                    <p className="text-xs text-slate-400 dark:text-slate-500">Requires mobile app — not available on web</p>
                  </div>
                  <div className="w-10 h-6 bg-slate-200 dark:bg-slate-700 rounded-full relative shrink-0">
                    <div className="w-4 h-4 bg-white dark:bg-slate-400 rounded-full shadow absolute top-1 left-1" />
                  </div>
                </div>
